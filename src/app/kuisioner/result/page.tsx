...
export default function ResultPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-black/80">Memproses hasil...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen py-10 px-4 text-black font-sans">
      <div className="max-w-6xl mx-auto mt-15">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-[2.5rem] shadow-sm border border-black/10 p-8 mb-12">
          <h2 className="text-2xl font-extrabold mb-6 text-black text-center">
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-lg text-center transition-all ${
                    isTopKategori
                      ? "bg-cyan-50 text-cyan-900 shadow-sm border border-cyan-200"
                      : "bg-black/5 text-black/70 border border-black/5"
                  }`}
                >
                  <p
                    className={`text-sm font-medium mb-2 ${isTopKategori ? "text-cyan-900" : ""}`}
                  >
                    {kategori}
                  </p>
                  <p
                    className={`text-3xl font-bold mb-2 ${isTopKategori ? "text-cyan-900" : "text-black/90"}`}
                  >
                    {skor}
                  </p>
                  <div className="w-full bg-black/10 rounded-full h-2">
                    <div
                      className={`h-2 rounded-full transition-all ${
                        isTopKategori ? "bg-cyan-500" : "bg-black/20"
                      }`}
        ...
        {/* Call to Action */}
        <div className="bg-cyan-50 backdrop-blur-lg rounded-[2rem] shadow-sm border border-cyan-100 p-8 text-center mb-12 text-black">
        ...
        {/* User Info */}
        <div className="bg-white/80 backdrop-blur-md rounded-3xl shadow-sm border border-black/10 p-6 mb-8 text-black">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            ...
            {result.biodata.is_kipk && (
              <div>
                ...
                <p className="font-semibold text-red-600">Penerima KIP-K</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex gap-4 justify-center">
          <button
            ...
            className="bg-black/5 hover:bg-black/10 text-black border border-black/20 px-8 py-3 rounded-xl font-bold transition backdrop-blur-sm"
          >
            ↻ Mulai Ulang
          </button>
          <button
