...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen py-10 px-4 text-white font-sans">
      <div className="max-w-6xl mx-auto mt-15">
        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-block bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl px-6 py-3 shadow-xl">
            <p className="text-lg font-semibold text-white">
              Kategori Dominan:{" "}
              <span className="text-2xl text-white">{highestCategory}</span>
            </p>
        ...
        <div className="mb-12 ">
          ...
          {ukmObjects.length > 0 ? (
            ...
            <div className="bg-amber-100/90 border border-amber-200/60 rounded-lg p-6 text-center">
        ...
        <div className="bg-gradient-to-br from-white/15 via-white/10 to-cyan-500/10 backdrop-blur-xl rounded-[2.5rem] shadow-[0_30px_60px_-30px_rgba(8,90,95,0.55)] border border-white/20 p-8 mb-12">
          <h2 className="text-2xl font-extrabold mb-6 text-white text-center">
              ...
              return (
                <div
                  ...
                  className={`p-4 rounded-lg text-center transition-all ${
                    isTopKategori
                      ? "bg-white/25 text-white shadow-[0_18px_30px_-18px_rgba(6,182,212,0.6)] border border-white/35"
        ...
        {/* Call to Action */}
        <div className="bg-gradient-to-r from-cyan-900/55 to-emerald-900/45 backdrop-blur-lg rounded-[2rem] shadow-[0_25px_50px_-25px_rgba(5,55,60,0.75)] border border-white/20 p-8 text-center mb-12 text-white">
        ...
        {/* User Info */}
        <div className="bg-gradient-to-br from-white/12 via-white/8 to-emerald-500/10 backdrop-blur-md rounded-3xl shadow-[0_20px_40px_-25px_rgba(8,90,95,0.6)] border border-white/20 p-6 mb-8 text-white">
          <h3 className="text-lg font-bold mb-4">Data Peserta</h3>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
            <div>
              <p className="text-white/70">Nama</p>
              <p className="font-semibold">{result.biodata.nama}</p>
            </div>
            <div>
              <p className="text-white/70">NIM</p>
              <p className="font-semibold">{result.biodata.nim}</p>
            </div>
            <div>
              <p className="text-white/70">Fakultas</p>
              <p className="font-semibold">{result.biodata.fakultas}</p>
            </div>
            <div>
              <p className="text-white/70">Jurusan</p>
              <p className="font-semibold">{result.biodata.jurusan}</p>
            </div>
            {result.biodata.agama && (
              <div>
                <p className="text-white/70">Agama</p>
            ...
            {result.biodata.is_kipk && (
              <div>
                ...
                <p className="font-semibold text-red-400">Penerima KIP-K</p>
              </div>
            )}
          </div>
        </div>
