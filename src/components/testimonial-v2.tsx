...
const Testimonials = () => {
  return (
    <section
      ...
      className="bg-transparent py-15 relative overflow-hidden"
    >
      <motion.div
      ...
      >
        <div className="flex flex-col items-center justify-center  mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl font-semibold tracking-tighter text-center text-gradient mb-2">
            ...
            edulur{" "}
            <span className="font-edwardian text-6xl sm:text-7xl mr-2">L</span>
            ainnya
          </h2>
          <p className="text-center mt-5 text-neutral-500 dark:text-neutral-400 text-lg leading-relaxed max-w-7xl transition-colors">
...
export default function TestimonialsSection() {
  return (
    <div className="w-screen min-h-screen  dark:bg-neutral-950 transition-colors duration-300 flex flex-col justify-center relative selection:bg-primary selection:text-white">
      {/* Dark Mode Toggle */}
