                ...
                <div className="flex h-auto items-start justify-between p-8">
                  <div>
                    ...
                    <motion.h3
                      ...
                      className="mt-0.5 text-4xl font-semibold text-black sm:text-4xl dark:text-white text-gradient-2"
                    >
                      {title}
                    </motion.h3>
                  </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex flex-col">
              ...
              <motion.h3
                layoutId={`title-${title}-${id}`}
                className="font-semibold text-black md:text-left dark:text-white text-gradient-2"
              >
                {title}
              </motion.h3>
            </div>
